		...
		<div id="da-slider" class="da-slider text-center">
			...
			<div class="da-slide">
				<h2 style="color: white;">Log In</h2>
                                <h3 class="da-link"><a href="includes/login.php" class="fa-btn btn-1 btn-1e" style="color: white;">Go there</a></h3>
			</div>
                    <?php }else if(isset($_SESSION['uid']) === true){ ?>
			<div class="da-slide">
				<h2 style="color: white;">Logout</h2>
                                <h3 class="da-link"><a href="includes/logout.php" class="fa-btn btn-1 btn-1e" style="color: white;">Go there</a></h3>
			</div>
                    <?php } ?>
			<div class="da-slide">
				<h2 style="color: white;">Admission</h2>

                                <h3 class="da-link"><a href="includes/admission.php" class="fa-btn btn-1 btn-1e" style="color: white;">Go there</a></h3>
			</div>
			<div class="da-slide">
				<h2 style="color: white;">Log In</h2>
			...
			<div class="da-slide">
				...
				<h3 class="da-link"><a href="single-page.html" class="fa-btn btn-1 btn-1e" style="color: white;">Go there</a></h3>
			</div>
		</div>
	</div>
</div><!-- end slider -->
	...
	<div class="container">
		<div class="main row">
			<div class="col-md-3 images_1_of_4 text-center">
                            ...
                            <a href="includes/login.php"><span class="bg"><i class="fa fa-globe"></i></span></a>
				<h4><a href="includes/login.php">Log In</a></h4>
			...
			<div class="col-md-3 images_1_of_4 bg1 text-center">
                                <a href="includes/admission.php"><span class="bg"><i class="fa fa-laptop"></i></span></a>
				<h4><a href="includes/admission.php">Admission</a></h4>
				<p class="para">Learn about our admission system and be a part of us</p>

			</div>
			<div class="col-md-3 images_1_of_4 bg1 text-center">
                                <a href="includes/notice.php"><span class="bg"><i class="fa fa-cog"></i></span></a>
				<h4><a href="includes/notice.php">Notice</a></h4>
				<p class="para">Do not miss what is important for you </p>

			</div>
			<div class="col-md-3 images_1_of_4 bg1 text-center">
                                <a href="includes/about.php"><span class="bg"><i class="fa fa-shield"></i> </span></a>
				<h4><a href="includes/about.php">About Us</a></h4>
